...
# 📖 [Wikipedia] <a name="about-project"></a>

**Wikipedia** is a simple ruby on rails application developed to help manage blog activities.
...
```
git clone https://github.com/byiringiroscar/wikipedia-project-with-rails
...
```
cd wikipedia-project-with-rails
```
